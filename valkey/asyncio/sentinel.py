...
class SentinelManagedConnection(Connection):
    ...
    async def connect(self):
        return await self.retry.call_with_retry(
            self._connect_retry, lambda error: anyio.lowlevel.checkpoint()
        )
...
class Sentinel(AsyncSentinelCommands):
    ...
    a normal Valkey connection can be specified here. If ``sentinel_kwargs`` is
    not specified, any socket_timeout and socket_keepalive options specified
    in ``connection_kwargs`` will be used.

    ``connection_kwargs`` are keyword arguments that will be used when
    establishing a connection to a Valkey server.
    """
    ...
    def __init__(
        ...
        **connection_kwargs,
        ...
        self.sentinels = [
            Valkey(host=hostname, port=port, **self.sentinel_kwargs)
    ...
    async def execute_command(self, *args, **kwargs):
        ...
        if once:
            ...
            tasks = [
                sentinel.execute_command(*args, **kwargs) for sentinel in self.sentinels
            ]
            await anyio_gather(*tasks)
        return True
    ...
    async def discover_master(self, service_name: str):
        """
        Asks sentinel servers for the Valkey master's address corresponding
    ...
    def master_for(
        self,
        service_name: str,
        valkey_class: Type[Valkey] = Valkey,
        ...
        **kwargs,
        ...
        A :py:class:`~valkey.sentinel.SentinelConnectionPool` class is
        ...
        By default clients will be a :py:class:`~valkey.Valkey` instance.
        Specify a different class to the ``valkey_class`` argument if you
        desire something different.

        The ``connection_pool_class`` specifies the connection pool to
        use.  The :py:class:`~valkey.sentinel.SentinelConnectionPool`
        will be used by default.

        All other keyword arguments are merged with any connection_kwargs
        passed to this class and passed to the connection pool as keyword
        arguments to be used to initialize Valkey connections.
        """
        ...
        # The Valkey object "owns" the pool
        return valkey_class.from_pool(connection_pool)
