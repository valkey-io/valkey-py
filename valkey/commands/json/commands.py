...
class JSONCommands:
    ...
    def arrappend(
        ...
        For more information see `JSON.ARRAPPEND <https://valkey.io/commands/json.arrappend>`_..
        """  # noqa
    ...
    def arrindex(
        ...
        For more information see `JSON.ARRINDEX <https://valkey.io/commands/json.arrindex>`_.
        """  # noqa
    ...
    def arrinsert(
        ...
        For more information see `JSON.ARRINSERT <https://valkey.io/commands/json.arrinsert>`_.
        """  # noqa
    ...
    def arrlen(
        ...
        For more information see `JSON.ARRLEN <https://valkey.io/commands/json.arrlen>`_.
        """  # noqa
    ...
    def arrpop(
        ...
        For more information see `JSON.ARRPOP <https://valkey.io/commands/json.arrpop>`_.
        """  # noqa
    ...
    def arrtrim(
        ...
        For more information see `JSON.ARRTRIM <https://valkey.io/commands/json.arrtrim>`_.
        """  # noqa
    ...
    def type(self, name: str, path: Optional[str] = Path.root_path()) -> List[str]:
        ...
        For more information see `JSON.TYPE <https://valkey.io/commands/json.type>`_.
        """  # noqa
    ...
    def resp(self, name: str, path: Optional[str] = Path.root_path()) -> List:
        ...
        For more information see `JSON.RESP <https://valkey.io/commands/json.resp>`_.
        """  # noqa
    ...
    def objkeys(
        ...
        For more information see `JSON.OBJKEYS <https://valkey.io/commands/json.objkeys>`_.
        """  # noqa
    ...
    def objlen(
        ...
        For more information see `JSON.OBJLEN <https://valkey.io/commands/json.objlen>`_.
        """  # noqa
    ...
    def numincrby(self, name: str, path: str, number: int) -> str:
        ...
        For more information see `JSON.NUMINCRBY <https://valkey.io/commands/json.numincrby>`_.
        """  # noqa
    ...
    def nummultby(self, name: str, path: str, number: int) -> str:
        ...
        For more information see `JSON.NUMMULTBY <https://valkey.io/commands/json.nummultby>`_.
        """  # noqa
        return self.execute_command(
    ...
    def clear(self, name: str, path: Optional[str] = Path.root_path()) -> int:
        ...
        For more information see `JSON.CLEAR <https://valkey.io/commands/json.clear>`_.
        """  # noqa
    ...
    def delete(self, key: str, path: Optional[str] = Path.root_path()) -> int:
        ...
        For more information see `JSON.DEL <https://valkey.io/commands/json.del>`_.
        """
    ...
    def get(
        ...
        For more information see `JSON.GET <https://valkey.io/commands/json.get>`_.
        """  # noqa
        pieces = [name]
        if no_escape:
    ...
    def mget(self, keys: List[str], path: str) -> List[JsonType]:
        ...
        For more information see `JSON.MGET <https://valkey.io/commands/json.mget>`_.
        """  # noqa
        pieces = []
        pieces += keys
    ...
    def set(
        ...
        For more information see `JSON.SET <https://valkey.io/commands/json.set>`_.
        """
        if decode_keys:
    ...
    def mset(self, triplets: List[Tuple[str, str, JsonType]]) -> Optional[str]:
        ...
        For more information see `JSON.MSET <https://valkey.io/commands/json.mset>`_.
        """
        pieces = []
    ...
    def merge(
        ...
        For more information see `JSON.MERGE <https://valkey.io/commands/json.merge>`_.
        """
        if decode_keys:
            obj = decode_dict_keys(obj)
    ...
    def strlen(self, name: str, path: Optional[str] = None) -> List[Union[int, None]]:
        ...
        For more information see `JSON.STRLEN <https://valkey.io/commands/json.strlen>`_.
        """  # noqa
        pieces = [name]
        if path is not None:
            pieces.append(str(path))
    ...
    def toggle(
        ...
        For more information see `JSON.TOGGLE <https://valkey.io/commands/json.toggle>`_.
        """  # noqa
    ...
    def strappend(
        ...
        For more information see `JSON.STRAPPEND <https://valkey.io/commands/json.strappend>`_.
        """  # noqa
    ...
    def debug(
        ...
        For more information see `JSON.DEBUG <https://valkey.io/commands/json.debug>`_.
        """  # noqa
