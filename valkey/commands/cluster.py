...
if TYPE_CHECKING:
    from valkey.asyncio.cluster import TargetNodesT
...
class ClusterManagementCommands(ManagementCommands):
    """
    A class for Valkey Cluster management commands

    The class inherits from Valkey's core ManagementCommands class and do the
    ...
    def slaveof(self, *args, **kwargs) -> NoReturn:
        ...
        """
        raise ValkeyClusterException("SLAVEOF is not supported in cluster mode")
    ...
    def replicaof(self, *args, **kwargs) -> NoReturn:
        ...
        """
        raise ValkeyClusterException("REPLICAOF is not supported in cluster mode")
    ...
    def swapdb(self, *args, **kwargs) -> NoReturn:
        ...
        """
        raise ValkeyClusterException("SWAPDB is not supported in cluster mode")
    ...
    def cluster_info(self, target_nodes: Optional["TargetNodesT"] = None) -> ResponseT:
        """
        Provides info about Valkey Cluster node state.
...
class ClusterDataAccessCommands(DataAccessCommands):
    """
    A class for Valkey Cluster Data Access Commands

    The class inherits from Valkey's core DataAccessCommand class and do the
    required adjustments to work with cluster mode
    """
...
class AsyncValkeyClusterCommands(
