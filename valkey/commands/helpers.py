...
import valkey
from valkey.typing import KeysT, KeyT
...
def get_protocol_version(client):
    if isinstance(client, valkey.Valkey) or isinstance(client, valkey.asyncio.Valkey):
        return client.connection_pool.connection_kwargs.get("protocol")
    elif isinstance(client, valkey.cluster.AbstractValkeyCluster):
