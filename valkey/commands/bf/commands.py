...
class BFCommands:
    ...
    def create(self, key, errorRate, capacity, expansion=None, noScale=None):
        ...
        For more information see `BF.RESERVE <https://valkey.io/commands/bf.reserve>`_.
        """  # noqa
    ...
    def add(self, key, item):
        ...
        For more information see `BF.ADD <https://valkey.io/commands/bf.add>`_.
        """  # noqa
    ...
    def madd(self, key, *items):
        ...
        For more information see `BF.MADD <https://valkey.io/commands/bf.madd>`_.
        """  # noqa
    ...
    def insert(
        ...
        For more information see `BF.INSERT <https://valkey.io/commands/bf.insert>`_.
        """  # noqa
        params = [key]
    ...
    def exists(self, key, item):
        ...
        For more information see `BF.EXISTS <https://valkey.io/commands/bf.exists>`_.
        """  # noqa
    ...
    def mexists(self, key, *items):
        ...
        For more information see `BF.MEXISTS <https://valkey.io/commands/bf.mexists>`_.
        """  # noqa
    ...
    def loadchunk(self, key, iter, data):
        ...
        For more information see `BF.LOADCHUNK <https://valkey.io/commands/bf.loadchunk>`_.
        """  # noqa
    ...
    def info(self, key):
        ...
        For more information see `BF.INFO <https://valkey.io/commands/bf.info>`_.
        """  # noqa
    ...
    def card(self, key):
        ...
        For more information see `BF.CARD <https://valkey.io/commands/bf.card>`_.
        """  # noqa
...
class CFCommands:
    ...
    def create(
        ...
        For more information see `CF.RESERVE <https://valkey.io/commands/cf.reserve>`_.
        """  # noqa
        params = [key, capacity]
        self.append_expansion(params, expansion)
    ...
    def add(self, key, item):
        ...
        For more information see `CF.ADD <https://valkey.io/commands/cf.add>`_.
        """  # noqa
    ...
    def addnx(self, key, item):
        ...
        For more information see `CF.ADDNX <https://valkey.io/commands/cf.addnx>`_.
        """  # noqa
    ...
    def insert(self, key, items, capacity=None, nocreate=None):
        ...
        For more information see `CF.INSERT <https://valkey.io/commands/cf.insert>`_.
        """  # noqa
        params = [key]
        self.append_capacity(params, capacity)
        self.append_no_create(params, nocreate)
    ...
    def insertnx(self, key, items, capacity=None, nocreate=None):
        ...
        `items` must be provided as a list.
        For more information see `CF.INSERTNX <https://valkey.io/commands/cf.insertnx>`_.
        """  # noqa
        params = [key]
        self.append_capacity(params, capacity)
        self.append_no_create(params, nocreate)
    ...
    def exists(self, key, item):
        ...
        For more information see `CF.EXISTS <https://valkey.io/commands/cf.exists>`_.
        """  # noqa
    ...
    def mexists(self, key, *items):
        ...
        For more information see `CF.MEXISTS <https://valkey.io/commands/cf.mexists>`_.
        """  # noqa
    ...
    def delete(self, key, item):
        ...
        For more information see `CF.DEL <https://valkey.io/commands/cf.del>`_.
        """  # noqa
    ...
    def count(self, key, item):
        ...
        For more information see `CF.COUNT <https://valkey.io/commands/cf.count>`_.
        """  # noqa
    ...
    def scandump(self, key, iter):
        ...
        For more information see `CF.SCANDUMP <https://valkey.io/commands/cf.scandump>`_.
        """  # noqa
    ...
    def loadchunk(self, key, iter, data):
        ...
        For more information see `CF.LOADCHUNK <https://valkey.io/commands/cf.loadchunk>`_.
        """  # noqa
    ...
    def info(self, key):
        ...
        For more information see `CF.INFO <https://valkey.io/commands/cf.info>`_.
        """  # noqa
...
class TOPKCommands:
    ...
    def reserve(self, key, k, width, depth, decay):
        ...
        For more information see `TOPK.RESERVE <https://valkey.io/commands/topk.reserve>`_.
        """  # noqa
    ...
    def add(self, key, *items):
        ...
        For more information see `TOPK.ADD <https://valkey.io/commands/topk.add>`_.
        """  # noqa
    ...
    def incrby(self, key, items, increments):
        ...
        For more information see `TOPK.INCRBY <https://valkey.io/commands/topk.incrby>`_.
    ...
    def query(self, key, *items):
        ...
        For more information see `TOPK.QUERY <https://valkey.io/commands/topk.query>`_.
        """  # noqa
    ...
    def count(self, key, *items):
        ...
        For more information see `TOPK.COUNT <https://valkey.io/commands/topk.count>`_.
        """  # noqa
    ...
    def list(self, key, withcount=False):
        ...
        For more information see `TOPK.LIST <https://valkey.io/commands/topk.list>`_.
        """  # noqa
        params = [key]
        if withcount:
    ...
    def info(self, key):
        ...
        For more information see `TOPK.INFO <https://valkey.io/commands/topk.info>`_.
        """  # noqa
...
class TDigestCommands:
    def create(self, key, compression=100):
        ...
        For more information see `TDIGEST.CREATE <https://valkey.io/commands/tdigest.create>`_.
        """  # noqa
    ...
    def reset(self, key):
        ...
        For more information see `TDIGEST.RESET <https://valkey.io/commands/tdigest.reset>`_.
        """  # noqa
    ...
    def add(self, key, values):
        ...
        For more information see `TDIGEST.ADD <https://valkey.io/commands/tdigest.add>`_.
        """  # noqa
    ...
    def merge(self, destination_key, num_keys, *keys, compression=None, override=False):
        ...
        For more information see `TDIGEST.MERGE <https://valkey.io/commands/tdigest.merge>`_.
        """  # noqa
    ...
    def min(self, key):
        ...
        For more information see `TDIGEST.MIN <https://valkey.io/commands/tdigest.min>`_.
        """  # noqa
    ...
    def max(self, key):
        ...
        For more information see `TDIGEST.MAX <https://valkey.io/commands/tdigest.max>`_.
        """  # noqa
    ...
    def quantile(self, key, quantile, *quantiles):
        ...
        For more information see `TDIGEST.QUANTILE <https://valkey.io/commands/tdigest.quantile>`_.
        """  # noqa
    ...
    def cdf(self, key, value, *values):
        ...
        For more information see `TDIGEST.CDF <https://valkey.io/commands/tdigest.cdf>`_.
        """  # noqa
    ...
    def info(self, key):
        ...
        For more information see `TDIGEST.INFO <https://valkey.io/commands/tdigest.info>`_.
        """  # noqa
    ...
    def trimmed_mean(self, key, low_cut_quantile, high_cut_quantile):
        ...
        For more information see `TDIGEST.TRIMMED_MEAN <https://valkey.io/commands/tdigest.trimmed_mean>`_.
        """  # noqa
    ...
    def rank(self, key, value, *values):
        ...
        For more information see `TDIGEST.RANK <https://valkey.io/commands/tdigest.rank>`_.
        """  # noqa
    ...
    def revrank(self, key, value, *values):
        ...
        For more information see `TDIGEST.REVRANK <https://valkey.io/commands/tdigest.revrank>`_.
        """  # noqa
    ...
    def byrank(self, key, rank, *ranks):
        ...
        For more information see `TDIGEST.BY_RANK <https://valkey.io/commands/tdigest.by_rank>`_.
        """  # noqa
    ...
    def byrevrank(self, key, rank, *ranks):
        ...
        For more information see `TDIGEST.BY_REVRANK <https://valkey.io/commands/tdigest.by_revrank>`_.
        """  # noqa
...
class CMSCommands:
    ...
    def initbydim(self, key, width, depth):
        ...
        For more information see `CMS.INITBYDIM <https://valkey.io/commands/cms.initbydim>`_.
        """  # noqa
    ...
    def initbyprob(self, key, error, probability):
        ...
        For more information see `CMS.INITBYPROB <https://valkey.io/commands/cms.initbyprob>`_.
        """  # noqa
    ...
    def incrby(self, key, items, increments):
        ...
        Both `items` and `increments` are lists.
        For more information see `CMS.INCRBY <https://valkey.io/commands/cms.incrby>`_.
    ...
    def query(self, key, *items):
        ...
        For more information see `CMS.QUERY <https://valkey.io/commands/cms.query>`_.
        """  # noqa
    ...
    def merge(self, destKey, numKeys, srcKeys, weights=[]):
        ...
        For more information see `CMS.MERGE <https://valkey.io/commands/cms.merge>`_.
        """  # noqa
    ...
    def info(self, key):
        ...
        For more information see `CMS.INFO <https://valkey.io/commands/cms.info>`_.
        """  # noqa
